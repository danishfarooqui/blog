...
@section('dashboard-content')
    ...
    <form action="{{URL::to('update-blog-post')}}/{{$blogPost->id}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" value="{{$blogPost->title}}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
        ...
        <div>
            <img id="photo" height="100" width="100" class="image" id="myDIV" >
        </div>
